...
separar los dígitos del número “binario”, uno por uno, de derecha a izquierda. Así como en el 
sistema de numeración decimal, el dígito más a la derecha tiene un valor de posición de 1, y 
...
derecha tiene un valor por posición de 1, el siguiente dígito a la izquierda tiene un valor por 
